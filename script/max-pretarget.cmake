...
if (WIN32)
	...
	if ((CMAKE_GENERATOR MATCHES "Visual Studio") OR (CMAKE_GENERATOR MATCHES "Ninja"))
		set(CMAKE_C_FLAGS_DEBUG            "/Zc:preprocessor /EHsc /D_DEBUG /Zi /Ob0 /Od /RTC1")
		set(CMAKE_C_FLAGS_MINSIZEREL       "/Zc:preprocessor /EHsc /O1 /Ob1 /D NDEBUG")
		set(CMAKE_C_FLAGS_RELEASE          "/Zc:preprocessor /EHsc /O2 /Ob2 /D NDEBUG")
		set(CMAKE_C_FLAGS_RELWITHDEBINFO   "/Zc:preprocessor /EHsc /Zi /O2 /Ob1 /D NDEBUG")

		set(CMAKE_CXX_FLAGS_DEBUG          "/Zc:preprocessor /EHsc /D_DEBUG /Zi /Ob0 /Od /RTC1")
		set(CMAKE_CXX_FLAGS_MINSIZEREL     "/Zc:preprocessor /EHsc /O1 /Ob1 /D NDEBUG")
		set(CMAKE_CXX_FLAGS_RELEASE        "/Zc:preprocessor /EHsc /O2 /Ob2 /D NDEBUG")
		set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "/Zc:preprocessor /EHsc /Zi /O2 /Ob1 /D NDEBUG")
	else()
